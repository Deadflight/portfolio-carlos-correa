...
const HomePage = () => {
	return (
		<MainLayout title="Home">
			<section className="bg-fourth h-screen space-y-3 md:space-y-0 max-h-screen items-center dark:bg-secondary flex flex-col md:flex-row text-center md:items-center md:text-left pb-28 px-5 md:px-10 md:py-14 ">
