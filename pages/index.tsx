...
const HomePage = () => {
	return (
		<MainLayout title="Home">
			<section className="bg-fourth max-h-screen dark:bg-secondary flex flex-col md:flex-row text-center md:items-center md:text-left py-8 px-5 md:px-10 md:py-14">
